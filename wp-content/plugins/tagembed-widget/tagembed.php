...
!defined('TAGEMBED_PLUGIN_VERSION') && define('TAGEMBED_PLUGIN_VERSION', '6.0');
...
function ___tagembed__dataAjaxHandler() {
	...
	case '__tagembed__register':
	    ...
	    ___tagembed__wpApiCall(TAGEMBED_PLUGIN_API_URL . 'apiwidget/create', $param, ['Authorization:' . $response->accessToken]);
	...
	case '__tagembed__create_feed':
		...
		case 3:
		    ...
		    break;
		case 4:
		    if (29 == $__tagembed__feed_filter_id) :
			$__tagembed__feed_input_data['auth'] = 1;
		    else :
		...
		case 28:
			...
			return ___tagembed__exitWithDanger('Validation Error', ['feed' => 'Enter	Capeterra	Company	Url']);
		    endif;
